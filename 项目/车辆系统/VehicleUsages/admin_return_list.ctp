...
<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue"><?php echo __("Vehicle Return") ?></h3>
	
		<div class="table-header"><?php echo __("List Vehicle Return") ?></div>
		...
		<tbody>
			...
			<tr role="row" class="odd">
				...
				<tr>
					...
					<?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-car bigger-130 purple'))." ". __('Return'), 
					array('action' => 'return_confirm',$vehicleUsage['VehicleUsage']['id']), 
					array('escape'=>false)); ?>
