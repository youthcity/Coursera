...
<fieldset><legend><?php echo __("Add Vehicle Insurances") ?></legend></fieldset> 
...
<div class="form-group">
  ...
  <?php 
  echo $this->Form->input('vehicle_id',array('div'=>'col-sm-3','label'=>false));
 ?>
...
<div class="form-group">
  ...
  <?php 
  echo $this->Form->input('insurance_tel',array('style'=>'width:100%','div'=>false,'label'=>false,'placeholder'=>"请输入电话号码",'type'=>'text'));
 ?>
...
<div class="form-group">
  ...
  <?php 
  echo $this->Form->input('insurance_company',array('style'=>'width:100%','div'=>'col-sm-3','label'=>false));
 ?>
 <span class="star">*</span>
</div>
...
<div class="form-group">
  ...
  <?php 
  echo $this->Form->input('insurance_type',array('style'=>'width:100%','div'=>'col-sm-3','label'=>false,'placeholder'=>"请输入保险种类",));
 ?>
 <span class="star">*</span>
</div>
...
<div class="form-group">
  ...
  <?php 
  echo $this->Form->input('insurance_cost',array('style'=>'width:100%','div'=>'col-sm-3','label'=>false,'placeholder'=>"请输入保险金额",'type'=>'text'));
 ?>
 <span class="star">*</span>
</div>
